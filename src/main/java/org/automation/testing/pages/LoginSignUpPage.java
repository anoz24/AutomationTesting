...
public class LoginSignUpPage extends BasePage {
    ...
    private final By signUpHeeading = By.cssSelector("div[class=\"signup-form\"] h2");
    private final By failedLoginSignUpMessage = By.cssSelector("p[style=\"color: red;\"]");
    ...
    public boolean isSignUpHeadingVisible() {
        return driver.findElement(signUpHeeading).isDisplayed();
    }

    public boolean isFailedLoginOrSignUpMessageDisplayed() {
        return driver.findElement(failedLoginSignUpMessage).isDisplayed();
    }
